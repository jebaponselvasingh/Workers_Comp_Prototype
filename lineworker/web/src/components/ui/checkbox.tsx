...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        // Stock `dark:` utilities stripped — Tailwind v4's default `dark:` is
        // prefers-color-scheme with no opt-in, and this app's palette is light
        // (see src/index.css). Same edit as `input.tsx` and every other
        // vendored primitive here.
