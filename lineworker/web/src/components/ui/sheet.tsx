...
function SheetContent({
  ...
  // House addition to the vendored component, in the same spirit as
  // dialog.tsx's `showCloseButton`: the overlay is rendered in here, so a
  // caller that needs to address it (a spec asserting backdrop-click
  // dismissal — the backdrop has no accessible role) has no other way to
  // reach it. `data-testid` is spelled out because JSX accepts `data-*` on
  // an element while a plain object literal typed as element props does not.
