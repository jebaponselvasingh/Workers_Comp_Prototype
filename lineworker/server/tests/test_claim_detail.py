...
async def test_the_payload_names_the_rules_version_behind_it(seeded_db_url: str) -> None:
    ...
    # Seven since Story 7.3 added the analyst workspace's age-band edges (six
    # since 7.1 added its fraud-band edges, five since 5.1 added the dashboard's
    # fraud-review cut-off, four since 3.1 added the PTD threshold). Pinned rather
